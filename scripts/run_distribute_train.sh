...
echo "For example: bash train_distribute.sh /home/x3d /home/publicfile/kinetics-400"
echo "================================================================================================"
set -e
if [ $# -lt 2 ]; then
...
mpirun -n 4 --allow-run-as-root python $PYTHON_PATH/src/example/arn_ucf101_train.py --run_distribute True \
